...
# Use SQLite for local development (easier on Windows)
...
#         'NAME': os.getenv('DB_NAME', 'mehndi_management'),
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'noreply@mehndimanagement.com')